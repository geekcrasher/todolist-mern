...
const Navbar = ({ onClick, isClick }) => {
  ...
  return (
    <nav className=" h-24 flex items-center justify-between fixed top-0 z-20 w-full  xs:px-6 md:px-10 dark:bg-[#191E24]">
        <NavLink to={"/todo"} className="flex items-center cursor-pointer">
            <span><ListTodo color="#A6ADB9" size={28} /></span>
            <span className="font-figtree lg:text-2xl ml-2 text-[#1E2936] dark:text-[#A6ADB9] lowercase">
               task
